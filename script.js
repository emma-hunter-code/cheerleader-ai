...
function generateQuote(event) {
  ...
  let prompt = `User instructions: Generate a quote about ${userInput.value}. The quote should be no more than 3 simple sentences. Please include quote marks at the start and end of the quote. After the quote, attribute the quote from '- from you to you.' and put this inside a new HTML <span> element with the class of 'attribute'. Please do not add any asterisks and do not include 'html' within the quote.`;
