...
function generateQuote(event) {
  ...
  let prompt = `User instructions: Generate a quote about ${userInput.value}. The quote should be no more than 3 simple sentences. Please include quote marks at the start and end of the quote. After the quote, include the text '- from you to you.' and put this inside a new HTML <span> element with class="attribute". Please do not add any asterisks and do not include 'html' within the quote.`;
